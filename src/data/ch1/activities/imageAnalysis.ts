...
export const imageAnalysisActivities: ImageAnalysisActivity[] = [
  {
    ...
    figureId: 'fig-1',
    questions: [
      { question: 'What is the female figure holding in this print?', answer: 'The torch of Enlightenment in one hand and the Charter of the Rights of Man in the other', options: ['A sword and shield', 'The torch of Enlightenment and the Charter of Rights of Man', 'A flag and a crown', 'A Bible and a cross'], correctIndex: 1 },
      { question: 'What do the shattered remains on the ground represent?', answer: 'The symbols of absolutist institutions', options: ['Ancient ruins', 'War weapons', 'Symbols of absolutist institutions', 'Broken statues of kings'], correctIndex: 2 },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: 'What are the rules of the Club of Thinkers?', answer: '"1. Silence is the first commandment. 2. Muzzles will be distributed to members upon entering."', options: ['Free speech and open debate', 'Silence as the first rule; muzzles for members', 'Weekly discussions on philosophy', 'Democratic voting on all issues'], correctIndex: 1 },
  ...
  },
  {
    ...
    figureId: 'fig-8',
    questions: [
      { question: 'What historical event does this painting depict?', answer: 'The massacre at Chios (1824) where 20,000 Greeks were said to have been killed by Ottoman Turks', options: ['The French Revolution', 'The Battle of Leipzig', 'The Massacre at Chios', 'The Congress of Vienna'], correctIndex: 2 },
  ...
  },
  {
    ...
    figureId: 'fig-20',
    questions: [
      { question: 'What does Britannia sitting over the globe symbolise?', answer: 'British imperial domination over the world — nationalism merged with imperialism', options: ['British trade partnerships', 'Britannia ruling the waves and the world', 'British tourism', 'British scientific achievements'], correctIndex: 1 },
