...
export const sourceAnalysisActivities: SourceComprehensionActivity[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { question: 'What political ends did List hope to achieve through economic measures?', answer: 'List believed economic unification would awaken national sentiment, create a fusion of individual and provincial interests, and engender national feeling — leading to political unification.', options: ['Military conquest of neighbours', 'Economic prosperity leading to national sentiment and political unity', 'Isolation from world trade', 'Abolition of all private property'], correctIndex: 1 },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: 'How does Louise Otto-Peters challenge this view?', answer: 'She argues that Liberty is indivisible — free men cannot exist while women are unfree. She asks how men who claim to fight for freedom can deny it to half of humanity.', options: ['She agrees with Welcker', 'She argues Liberty is indivisible and cannot exist for only half of humanity', 'She says women should focus on the home', 'She demands women join the army'], correctIndex: 1 },
