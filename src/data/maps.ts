    ...
    regions: [
      {
        id: 'france',
        label: 'France',
        x: 16, y: 52, width: 16, height: 22,
        description: 'Bourbon dynasty restored after Napoleon\'s defeat. France returned to its pre-Revolution boundaries.',
      },
      {
        id: 'russian-empire',
        label: 'Russian Empire',
        x: 55, y: 12, width: 38, height: 50,
        description: 'The largest empire in Europe. Given part of Poland by the Congress of Vienna.',
      },
      {
        id: 'austrian-empire',
        label: 'Austrian Empire',
        x: 33, y: 44, width: 22, height: 22,
        description: 'Habsburg Empire — a patchwork of many peoples. Given control of northern Italy and parts of Germany.',
      },
      {
        id: 'prussia',
        label: 'Prussia',
        x: 33, y: 30, width: 18, height: 16,
        description: 'Given important new territories in western Germany (Rhineland) and part of Saxony.',
      },
      {
        id: 'ottoman-empire',
        label: 'Ottoman Empire',
        x: 42, y: 68, width: 28, height: 22,
        description: 'Controlled most of the Balkans. Its disintegration in the 19th century led to intense rivalry.',
      },
      {
        id: 'spain',
        label: 'Spain',
        x: 6, y: 68, width: 18, height: 18,
        description: 'Bourbon monarchy also restored here. Lost most of its Latin American colonies by the 1820s.',
      },
      {
        id: 'great-britain',
        label: 'Great Britain',
        x: 14, y: 22, width: 12, height: 22,
        description: 'Island nation — the dominant naval and industrial power. Did not attend the Congress of Vienna as a continental power.',
      },
    ],
  },
  {
