...
**⚠️ OPEN — Neha wants to revisit the whole exam/test-engine experience** (flagged 2026-07-19 after the alignment pass). Do NOT treat the test-engine UX as settled until her review round lands. Her paper-authoring verdict (PAPER_AUTHORING_GUIDE.md format) is part of the same review. Sprint 5 must not start build on marking UX before this.
